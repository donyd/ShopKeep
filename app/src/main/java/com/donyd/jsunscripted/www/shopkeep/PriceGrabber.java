...
import com.donyd.jsunscripted.www.shopkeep.ui.camera.CameraSourcePreview;
...
public class PriceGrabber extends AppCompatActivity {
    ...
    private void createCameraSource(boolean autoFocus, boolean useFlash) {
        ...
        if(!textRecognizer.isOperational()){
            ...
            // Check for low storage. If low, native library won't be downloaded
            // and detection will not become operational.
